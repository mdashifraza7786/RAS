...
export default function ChefLayout({
  ...
  // Use authentication hook to protect chef routes
  const { isAuthenticated = false, isLoading } = useManagerAuth('chef');
  ...
  return (
    <div className="flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        ...
        <main 
          ref={mainContentRef}
          className="flex-1 overflow-auto p-6 pb-14 bg-gray-50"
        >
          {children}
        </main>
      </div>
